      ...
      <main className="pt-16">
        ...
        <section className="relative aspect-[16/9] overflow-hidden md:aspect-[21/9]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6">
            <SectionReveal>
              <Quote className="mx-auto h-10 w-10 text-white/40 md:h-12 md:w-12" />
              <blockquote className="mt-4 font-display max-w-4xl text-center text-3xl font-light leading-snug text-white md:text-4xl lg:text-5xl">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
            <div className="grid gap-16 lg:grid-cols-2 lg:gap-24 lg:items-center">
              <SectionReveal>
                ...
                <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight text-[#111111] md:text-5xl">
                  Born from the soil
                </h2>
        ...
        <section className="bg-[#2F6F4F] py-20 md:py-28">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <SectionReveal>
              <p className="text-center font-display text-2xl font-light leading-relaxed text-white md:text-3xl lg:text-4xl">
