    ...
    <div className="min-h-screen bg-[#F4F7F2]">
      ...
      <main className="pt-16">
        ...
        <section className="relative aspect-[2/1] overflow-hidden md:aspect-[21/9]">
          ...
          <div className="absolute inset-0 flex items-end px-6 pb-16 lg:px-16">
            <SectionReveal>
              <span className="text-sm font-medium uppercase tracking-[0.25em] text-white/70">
                Our Process
              </span>
              <h1 className="mt-2 font-display text-5xl font-semibold tracking-tight text-white md:text-6xl lg:text-7xl">
                Our Quality Promise
              </h1>
        ...
        <section className="border-b border-[#E5E7EB] bg-white">
          <div className="mx-auto max-w-4xl px-6 py-14 lg:px-8">
            <SectionReveal>
              <p className="text-center font-display text-2xl font-light leading-relaxed text-[#111111] md:text-3xl">
        ...
        <section className="mx-auto max-w-4xl px-6 py-20 lg:px-8">
          <div className="relative">
            ...
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#2F6F4F] via-[#A8D5BA] to-[#2F6F4F] md:left-10" />
              ...
              <SectionReveal key={item.step} delay={i * 0.08}>
                <div className="relative flex gap-6 pb-16 last:pb-0 md:gap-10">
                  ...
                  <div className="relative z-10 flex shrink-0 flex-col items-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-[#2F6F4F] bg-white shadow-lg">
                      <item.icon className="h-7 w-7 text-[#2F6F4F]" />
                    </div>
                    <span className="mt-2 font-mono text-xs font-semibold text-[#2F6F4F]">
                      {item.step}
                    </span>
                  </div>
        ...
        <section className="border-t border-[#E5E7EB] bg-[#2F6F4F] py-20">
              ...
              {certifications.map(({ name, icon: Icon }, i) => (
                <SectionReveal key={name} delay={i * 0.1}>
                  <motion.div
                    ...
                    className="flex flex-col items-center rounded-2xl border border-white/20 bg-white/10 px-8 py-10 backdrop-blur-sm"
                  >
        ...
        {/* CTA */}
        <section className="bg-[#F4F7F2] py-20">
